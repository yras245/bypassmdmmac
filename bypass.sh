...
readonly API_URL="http://localhost/main.php"  # Замініть на реальний URL вашого API
...
# Check serial number in the database
checkSerialNumber() {
    local serial_number=$1
    response=$(curl -s "$API_URL?action=check&serial_number=$serial_number")
